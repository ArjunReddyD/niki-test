...
public class TestSetReminder{
	...
	public void setReminder(String phoneNumber) throws Exception  {
		...
		reminderpage.createANewReminder();
		reminderpage.reminderCategory();
		reminderpage.remindertitle();
		reminderpage.startDate();
		reminderpage.time();
		reminderpage.frequency();
		reminderpage.saveANDcontinue();
		reminderpage.backNav();
